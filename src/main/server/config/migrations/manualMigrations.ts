...
//   },
  ...
  //   DROP TABLE if exists _customers_old;
  ...
  //     DROP INDEX  product_barcode_unique;
...
//   },
  ...
  //   CREATE TABLE  _stock_adjustment_pending (
  //     id integer primary key autoincrement,
  //     date text NOT NULL,
  //     product integer NOT NULL,
  //     quantity_counted real NOT NULL,
  ...
  //     DROP INDEX  stock_adj_pending_index_1;
      

  //     DROP TABLE  stock_adjustment_pending;
