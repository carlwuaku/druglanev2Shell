...
export const GET_SYSTEM_ERRORS = "getsystemErrors";
export const SYSTEM_ERRORS_RECEIVED = "systemErrorsReceived";
export const GET_ACTIVATION_STATE = "getActivationState";
...
export const LICENSE_KEY = "activation_license";
export const SECRET_KEY = "secret_key";
export const ACTIVATION_STATE_RECEIVED = "activationStateReceived";
